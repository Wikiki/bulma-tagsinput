...
Tagify.prototype.enable=function(){var a=this;this.enabled||this.options.disabled||(this.element.addEventListener("focus",function(){a.container.classList.add("focus");a.select(Array.prototype.slice.call(a.container.querySelectorAll(".tag:not(.is-delete)")).pop())}),this.input.addEventListener("focus",function(){a.container.classList.add("focus");a.select(Array.prototype.slice.call(a.container.querySelectorAll(".tag:not(.is-delete)")).pop())}),this.input.addEventListener("blur",function(){a.container.classList.remove("focus");
a.select(Array.prototype.slice.call(a.container.querySelectorAll(".tag:not(.is-delete)")).pop());a.savePartial()}),this.input.addEventListener("keypress",function(b){var c=b.charCode||b.keyCode||b.which,d,e=a.container.querySelector(".is-active"),f=Array.prototype.slice.call(a.container.querySelectorAll(".tag:not(.is-delete)")).pop(),g=a.caretAtStart(b);e&&(d=a.container.querySelector('[data-tag="'+e.innerHTML.trim()+'"]'));a.setInputWidth();if(13===c||c===a.options.delimiter.charCodeAt(0)||9===c){if(!a.input.value&&
c!==a.options.delimiter.charCodeAt(0))return;a.savePartial()}else if(46===c&&d)d.nextSibling!==a.input&&a.select(d.nextSibling),a.container.removeChild(d),delete a.tags[a.tags.indexOf(d.getAttribute("data-tag"))],a.setInputWidth(),a.save();else if(8===c)if(d)a.select(d.previousSibling),a.container.removeChild(d),delete a.tags[a.tags.indexOf(d.getAttribute("data-tag"))],a.setInputWidth(),a.save();else if(f&&g)a.select(f);else return;else if(37===c)if(d)d.previousSibling&&select(d.previousSibling);
else if(g)a.select(f);else return;else if(39===c){if(!d)return;a.select(d.nextSibling)}else return a.select();b.preventDefault();return!1}),this.input.addEventListener("input",function(){a.element.value=a.getValue();a.element.dispatchEvent(new Event("input"))}),this.input.addEventListener("paste",function(){return setTimeout(savePartial,0)}),this.container.addEventListener("mousedown",function(b){a.refocus(b)}),this.container.addEventListener("touchstart",function(b){a.refocus(b)}),this.savePartial(this.element.value),
this.enabled=!0)};Tagify.prototype.disable=function(){this.enabled&&!this.options.disabled&&(this.reset(),this.enabled=!1)};Tagify.prototype.select=function(a){var b=this.container.querySelector(".is-active");b&&b.classList.remove("is-active");a&&a.classList.add("is-active")};
